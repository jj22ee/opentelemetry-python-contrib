...
from opentelemetry.samplers.aws._matcher import _Matcher, cloud_platform_mapping
...
class _SamplingRuleApplier:
    ...
    def matches(self, resource: Resource, attributes: Attributes) -> bool:
        url_path: Optional[AttributeValue] = None
        url_full: Optional[AttributeValue] = None
        http_request_method: Optional[AttributeValue] = None
        server_address: Optional[AttributeValue] = None
        service_name: Optional[AttributeValue] = None
